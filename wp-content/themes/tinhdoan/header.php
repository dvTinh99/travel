...
<head>
    ...
    <link rel="shortcut icon" href="<?= bloginfo('template_directory')?>/images/dragon.png" />
...
<body>
    <header>
        ...
        <div class="navigation-top">
            ...
            <nav class="navbar navbar-expand-xl navbar-dark bg-primary" style="background-color: #74f4ff !important;">
