<?php
/*
* Template Name: chau-phi
*/
?>
<?php get_header(); ?>

<div id="main">
        <div id="slider-chau-phi">
            <style>
                #slider-chau-phi {
                    padding-top: 20%;
                    background: url(<?php bloginfo('template_directory') ?>/images/chau-phi.jpg) top / cover no-repeat;
                    /* max-height: 480px; */
                }
