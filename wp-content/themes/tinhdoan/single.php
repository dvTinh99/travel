                                    ...
                                    <div class="col-md-2 col-sm-12 col-xs-12 packageInfo">
                                        ...
                                        <div class="action-book">
                                            <form method="POST" action="/booking">
                                                ...
                                                <button class="btn btn-buy-tour" href="/booking/book-tour/pax-no/21763?type=buy">
                                                    Đặt tour
                                                </button>
                                            </form>
                                        </div>
                                ...
                                <article class="box isotopeSelector box-kiritm box-tour">
                                    <figure>
                                        <a href="<?= the_permalink(); ?>" class="popup-gallery image-box-relative image-box-3x2">
                                            <img width="100%" height="250" alt="Du lịch Phan Thiết - Mũi Né - Lâu Đài Rượu Vang" src="<?php bloginfo('template_directory') ?>/images/diadiemhot.jpg">
                                        </a>
                                    </figure>
                                    ...
                                    <div class="details-kiritm">
                                        <div class="name-tour-detail">
                                            <a href="<?= the_permalink(); ?>" data-url="/vi/tour-trong-nuoc/3775/du-lich-phan-thiet-mui-ne-lau-dai-ruou-vang" data-id="3775" data-name="Du lịch Phan Thiết - Mũi Né - Lâu Đài Rượu Vang" data-price="3459000" data-category="Tour Phan Thiết" data-brand="tour-trong-nuoc" data-list="List" data-position="1" class="GAproductClick" title="Du lịch Phan Thiết - Mũi Né - Lâu Đài Rượu Vang">
                                                <?= the_title(); ?>
                                            </a>
                                        </div>
